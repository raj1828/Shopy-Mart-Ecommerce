        ...
        return (
            <div>
               <div className="container my-3">
                    <h2 className="text-center">Welcome to our E-Commerce Store - Shopy Mart</h2>
                    <p className="text-center" style={{fontSize: "20px"}}>India's No. 1 Leading Shoping Website</p>
                    <div className="row">
                    {this.state.items.map((element)=>{
                        return <div className="col-md-4" key={element.id}>
                                <Cart  title={element.title} description={element.description} imgUrl={element.img} price={element.price}/>
                            </div>
                    })}
